...
export const dictionary = {
  en: {
    ...
    askPlaceholder: "Name the question.",
    ...
    onlineShuffleDescription:
      "Let the deck move before you ask it to answer.",
    onlineCutDescription: "Make one clean pause before the card is chosen.",
    onlineDrawStepDescription:
      "Let one card come forward for this question.",
  ...
  zh: {
    ...
    onlineShuffleDescription: "让牌面先动起来，不急着要答案。",
    onlineCutDescription: "在选择出现前，给自己一个清楚的停顿。",
    onlineDrawStepDescription: "让一张牌为这个问题来到面前。",
    revealCard: "揭示这张牌",
    revealReading: "查看解读",
    physicalDeck: "实体牌组",
