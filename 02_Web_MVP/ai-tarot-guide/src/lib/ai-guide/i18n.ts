...
export const dictionary = {
  en: {
    ...
    aiFallbackNoticeBody:
      "The live AI reader was unavailable, so Ora saved this fallback reflection instead. No Stardust was used.",
    aiRetryReading: "Regenerate Reading",
    aiFollowUpSoon: "Follow-up questions will be supported soon.",
    aiFollowUpTitle: "Ask a follow-up",
    aiFollowUpHelper:
      "Follow-ups stay with this reading and do not draw new cards.",
    aiFollowUpPlaceholder: "Ask a follow-up about this reading...",
    aiFollowUpButton: "Ask Ora",
    aiFollowUpLoading: "Ora is reflecting...",
    aiFollowUpLimitReached:
      "This reading has reached its follow-up limit for now.",
    aiFollowUpError: "Follow-up request failed. Please try again.",
    aiFollowUpTooLong: "Please keep follow-ups under 300 characters.",
    aiFollowUpUserLabel: "You asked",
    aiFollowUpOraLabel: "Ora answered",
    aiFollowUpFallbackNotice:
      "This is a brief fallback response, not a live AI follow-up.",
    aiSummary: "Summary",
    ...
    readingsFallbackNote:
      "System fallback saved because the live AI reader was unavailable. No Stardust was used.",
  ...
  zh: {
    ...
    aiFallbackNoticeBody:
      "实时 AI 解读暂时不可用，因此 Ora 保存了这份备用反思。本次没有消耗星尘。",
    aiRetryReading: "重新生成解读",
    aiFollowUpSoon: "继续追问功能即将支持",
    aiFollowUpTitle: "继续追问",
    aiFollowUpHelper: "追问会基于本次解读回答，不会重新抽牌。",
    aiFollowUpPlaceholder: "继续追问这次解读...",
    aiFollowUpButton: "追问 Ora",
    aiFollowUpLoading: "Ora 正在思考...",
    aiFollowUpLimitReached: "本次解读的追问已达到上限。",
    aiFollowUpError: "追问请求失败，请稍后再试。",
    aiFollowUpTooLong: "请将追问控制在 300 字以内。",
    aiFollowUpUserLabel: "你的追问",
    aiFollowUpOraLabel: "Ora 的回应",
    aiFollowUpFallbackNotice: "这是简短备用回应，不是实时 AI 追问。",
    aiSummary: "概要",
    aiDirectAnswer: "直接回应",
    aiCardMeaning: "牌面含义",
    aiCardMessage: "牌的提示",
    ...
    readingsFallbackNote:
      "实时 AI 解读不可用时保存的系统备用反思。本次没有消耗星尘。",
