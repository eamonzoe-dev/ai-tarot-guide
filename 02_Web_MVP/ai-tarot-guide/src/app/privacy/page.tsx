  ...
  return (
    ...
    >
      <section className="border-t border-[#3d3020] pt-5">
        <h2 className="font-serif text-2xl text-[#f6ecd8]">What we collect</h2>
      ...
      <section className="border-t border-[#3d3020] pt-5">
        <h2 className="font-serif text-2xl text-[#f6ecd8]">Reading logs</h2>
        <p className="mt-3 text-sm leading-7 text-[#c8bca6]">
      ...
      <section className="border-t border-[#3d3020] pt-5">
        <h2 className="font-serif text-2xl text-[#f6ecd8]">How data is used</h2>
        <p className="mt-3 text-sm leading-7 text-[#c8bca6]">
      ...
      <section className="border-t border-[#3d3020] pt-5">
        <h2 className="font-serif text-2xl text-[#f6ecd8]">Third-party services</h2>
        <p className="mt-3 text-sm leading-7 text-[#c8bca6]">
      ...
      <section className="border-t border-[#3d3020] pt-5">
        <h2 className="font-serif text-2xl text-[#f6ecd8]">Your choices</h2>
        <p className="mt-3 text-sm leading-7 text-[#c8bca6]">
