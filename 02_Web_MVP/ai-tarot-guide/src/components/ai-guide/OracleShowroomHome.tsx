  ...
  return (
    <div className="min-h-svh bg-[#f4efe5] text-[#33291f]">
      ...
      <main className="relative overflow-x-hidden">
        ...
        <section className="relative mx-auto grid min-h-[calc(100svh-4.75rem)] w-full max-w-6xl items-center gap-8 px-5 pb-12 pt-8 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-16">
          <div
          ...
          >
            ...
            <h1 className="font-serif text-[clamp(4.6rem,20vw,10.5rem)] leading-[0.78] text-[#3f352b]">
              <span className="block">ASK</span>
              <span className="block">THE</span>
              <span className="block">CARD</span>
            </h1>
            <p className="mt-6 max-w-xl font-serif text-xl leading-8 text-[#5b4a36] sm:text-2xl">
              {copy.subtitle}
            </p>
          ...
          <div
            className="relative min-h-[33rem] sm:min-h-[40rem]"
            style={{ transform: `translateY(${parallax * 0.35}px)` }}
          >
            <div
              className={cx(
                revealClass("hero-stage"),
                "relative mx-auto h-[33rem] w-full max-w-[30rem] sm:h-[40rem] sm:max-w-[36rem]",
              )}
            ...
            >
              {/* gold star compass */}
              <div className="absolute left-1/2 top-6 h-72 w-72 -translate-x-1/2 rounded-full border border-[#d8b76a]/26 sm:h-[26rem] sm:w-[26rem]" />
              <div className="absolute left-1/2 top-14 h-52 w-52 -translate-x-1/2 rounded-full border border-[#caa96a]/18 sm:h-80 sm:w-80" />
              <div className="absolute left-1/2 top-12 h-px w-[min(34rem,90vw)] -translate-x-1/2 bg-gradient-to-r from-transparent via-[#caa96a]/55 to-transparent" />
              <div className="absolute left-1/2 top-28 h-px w-[min(28rem,80vw)] -translate-x-1/2 rotate-[30deg] bg-gradient-to-r from-transparent via-[#caa96a]/36 to-transparent" />
              <div className="absolute left-1/2 top-28 h-px w-[min(28rem,80vw)] -translate-x-1/2 -rotate-[30deg] bg-gradient-to-r from-transparent via-[#caa96a]/36 to-transparent" />
              ...
              <div className="absolute left-1/2 top-20 w-28 -translate-x-1/2 translate-x-[-3.4rem] -rotate-[20deg] sm:top-24 sm:w-36">
                <CardBack className="shadow-[0_18px_44px_rgba(18,13,8,0.3)]" />
              </div>
              <div className="absolute left-1/2 top-20 w-28 -translate-x-1/2 translate-x-[3.4rem] rotate-[20deg] sm:top-24 sm:w-36">
                <CardBack className="shadow-[0_18px_44px_rgba(18,13,8,0.3)]" />
              </div>
              <div className="absolute left-[10%] top-28 w-28 -rotate-[12deg] sm:left-[8%] sm:w-40">
                <CardBack />
              </div>
              <div className="absolute right-[10%] top-28 w-28 rotate-[12deg] sm:right-[8%] sm:w-40">
                <CardFace keyword="Hope" name="The Star" numeral="XVII" />
              </div>
              {/* center hero card — thick, raised */}
              <div className="absolute left-1/2 top-12 w-44 -translate-x-1/2 sm:w-56">
                <div className="absolute inset-0 translate-y-2 rounded-[1.35rem] bg-[#2c2016]/22 blur-[2px]" />
                <CardFace
                  keyword="Beginnings"
                  name="The Fool"
                  numeral="0"
              ...
              <div className="absolute bottom-6 left-1/2 w-[min(25rem,92vw)] -translate-x-1/2 rotate-[-3deg] rounded-[1.1rem] border border-[#caa96a]/40 bg-[#fffaf0]/92 p-5 shadow-[0_22px_56px_rgba(111,84,43,0.18),inset_0_1px_0_rgba(255,255,255,0.78)]">
            ...
            {[
              ...
              <Link
                className={cx(
                  ...
                  "group relative flex min-h-[21rem] flex-col justify-between overflow-hidden rounded-[1.6rem] border p-6 shadow-[0_20px_52px_rgba(102,75,33,0.12)] transition duration-[260ms] hover:-translate-y-1.5 hover:scale-[1.015] motion-reduce:transform-none",
                  item.tone === "green" &&
                    "border-[#31483f]/30 bg-[#21362f] text-[#f4efe5] hover:shadow-[0_28px_66px_rgba(33,54,47,0.28)]",
                  item.tone === "light" &&
                    "border-[#d8b76a]/36 bg-[linear-gradient(170deg,#fffaf0,#f1e4cb)] text-[#3f352b] hover:border-[#b9934f]/62",
                  item.tone === "product" &&
                    "border-[#d8b76a]/30 bg-[#fbf3e4]/82 text-[#3f352b] hover:border-[#b9934f]/55",
                )}
              ...
              >
                ...
                {item.tone === "light" && (
                  <span aria-hidden="true" className="pointer-events-none absolute -right-6 top-6 w-24 rotate-[10deg] opacity-90 sm:w-28">
                    <CardFace keyword="Begin" name="The Fool" numeral="0" />
                  </span>
                )}
                {item.tone === "green" && (
                  <span aria-hidden="true" className="pointer-events-none absolute -right-5 top-8">
                    <span className="block h-28 w-20 rotate-[8deg] rounded-md border border-[#d8b76a]/45 bg-[#1a2a24] shadow-[0_16px_40px_rgba(0,0,0,0.32),inset_0_0_0_6px_rgba(216,183,106,0.18)]" />
                    <span className="absolute -left-4 top-3 h-28 w-20 rotate-[-6deg] rounded-md border border-[#d8b76a]/30 bg-[#22382f]" />
                  </span>
                )}
                {item.tone === "product" && (
                  <span aria-hidden="true" className="pointer-events-none absolute -right-3 top-7 flex gap-1.5 rotate-[6deg]">
                    <span className="h-24 w-16 rounded-[6px] border border-[#caa96a]/45 bg-[#fffaf0] shadow-[0_12px_30px_rgba(102,75,33,0.16)]" />
                    <span className="h-24 w-16 -translate-y-2 rounded-[6px] border border-[#caa96a]/35 bg-[#f6ecd6]" />
                  </span>
                )}
                <span
                  className={cx(
