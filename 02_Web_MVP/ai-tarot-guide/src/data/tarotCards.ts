...
export const tarotCards: TarotCard[] = [
  {
    ...
    uprightMessage:
      "What This Means For Your Question: In this reading, the next honest step may matter more than planning every detail first. The Fool can reflect movement, trust, and learning through experience.",
    shadowMessage:
    ...
    practicalAdvice:
      "A Practical Next Step: Consider one small action that is reversible: a message, a question, a first draft, or a simple test before a larger commitment.",
    reflectionQuestion:
  ...
  },
  {
    ...
    uprightMessage:
      "What This Means For Your Question: This card may point to the quality of the choice in front of you, not only the desire of the moment. Notice which option helps you remain honest with yourself afterward.",
    shadowMessage:
    ...
    practicalAdvice:
      "A Practical Next Step: It may help to write down your non-negotiables before responding. Then compare your next action with those values instead of reacting only to pressure or longing.",
    reflectionQuestion:
  ...
  },
  {
    ...
    uprightMessage:
      "What This Means For Your Question: The situation may be asking for release rather than repair. If a pattern has already completed its lesson, this card invites you to notice what is ready to change form.",
    shadowMessage:
    ...
    practicalAdvice:
      "A Practical Next Step: A useful reflection may be to notice one thing you no longer need to keep feeding: an old argument, a stale plan, a false obligation, or a self-image that has become too small.",
    reflectionQuestion:
  ...
  },
  {
    ...
    practicalAdvice:
      "A Practical Next Step: Try separating facts from panic. List what actually happened, what you now know, and what decision can wait until you are steadier.",
    reflectionQuestion:
  ...
  },
  {
    ...
    uprightMessage:
      "What This Means For Your Question: The situation may need patience more than force. Clarity may come through steadiness, care, and a renewed relationship with hope.",
    shadowMessage:
    ...
    practicalAdvice:
      "A Practical Next Step: Consider returning to one restorative habit and protecting it. Sleep, water, a quiet walk, or a sincere conversation may do more than another round of overthinking.",
    reflectionQuestion:
  ...
  },
  {
    ...
    practicalAdvice:
      "A Practical Next Step: If possible, avoid a major irreversible decision at peak emotion. Write down what you notice, sleep on it, and look for evidence in the morning.",
    reflectionQuestion:
